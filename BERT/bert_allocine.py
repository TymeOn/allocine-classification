...
tokenizer = AutoTokenizer.from_pretrained('tblard/tf-allocine', do_lower_case=True)
...
model = TFAutoModelForSequenceClassification.from_pretrained('tblard/tf-allocine', num_labels=len(label_encoder.classes_), ignore_mismatched_sizes=True)
